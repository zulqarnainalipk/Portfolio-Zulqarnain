...
export const research = [
  {
    ...
    year: 2025,
    journal: 'Preprint',
    link: 'https://doi.org/10.48550/arXiv.XXXXX',
  ...
  },
  {
    ...
    link: 'https://journalofsra.com/2024/xxxxx',
...
export const awards = [
    ...
    items: [
      {
        ...
        link: 'https://www.kaggle.com/zulqarnainalipk',
      },
      {
        title: 'Bronze Medal',
        ...
        link: 'https://www.kaggle.com/competitions/jane-street-market-prediction',
      },
      {
        title: 'Bronze Medal',
        ...
        link: 'https://www.kaggle.com/competitions/rsna-2024-abdominal-trauma-detection',
      },
      {
        title: 'Bronze Medal',
    ...
    items: [
      {
        ...
        link: 'https://zindi.africa/competitions/cgi-ar-root-volume-estimation-challenge',
      },
      {
        title: 'Gold Medal',
      ...
      },
      {
        ...
        link: 'https://solafune.com/competitions/aerosol-estimation',
      },
      {
        title: 'Bronze Star',
        ...
        link: 'https://solafune.com/competitions/field-area-segmentation',
      },
      {
        title: 'Bronze Medal',
        ...
        link: 'https://zindi.africa/competitions/ai-ml-5g-challenge',
      },
      {
        title: 'Bronze Medal',
      ...
      {
        title: 'Bronze Medal',
        organization: 'Specializing LLMs for Telecom',
        year: 2024,
        description: 'Large language model fine-tuning for telecom applications.',
        link: 'https://zindi.africa/competitions/specializing-llms-for-telecom',
      },
    ],
  },
  // Academic Awards
  {
    ...
    items: [
      ...
      {
        title: '1st Position',
        organization: 'Data Science Olympiad, IUB',
        year: 2024,
...
export const certifications = [
  ...
  },
  {
    ...
    issuer: 'IBM',
    link: 'https://www.coursera.org/specializations/ibm-ai-enterprise-workflow',
  },
  {
    title: 'Applied Data Science Lab',
    issuer: 'WorldQuant University',
    link: 'https://www.wqu.edu/programs/applied-data-science-lab',
  },
  {
    title: 'Applied AI Lab',
    issuer: 'WorldQuant University',
    link: 'https://www.wqu.edu/programs/applied-ai-lab',
  },
  {
...
export const volunteer: Volunteer[] = [
  ...
  },
  {
    ...
    organization: 'Kaggle',
    date: '2022 - Present',
    description: 'Active participant in ML competitions with multiple medals in computer vision and NLP. Sharing knowledge through notebooks and discussions.',
    icon: '🎯',
    iconBg: '#050816',
  },
]
...
export const socialLinks = {
  ...
  kaggle: 'https://kaggle.com/zulqarnainalipk',
  instagram: 'https://instagram.com/zulqarnainalipk',
